            ...
            while($row = mysqli_fetch_array($query)) {
                ...
                echo    "<tr class='row100 body'>
                            ...
                            <td class='cell100 column5'>
                                <img src='../item/images/other_img/remove.png' alt='Remove' class='removeIcon pointer' onclick='deleteUser(\"".$row['id']."\")'>
                            </td>
            ...
            while($row = mysqli_fetch_array($query)) {
                echo    "<tr class='row100 body'>
                            ...
                            <td class='cell100 column4'>
                                <img src='../item/images/other_img/remove.png' alt='Remove' class='removeIcon pointer' onclick='deleteSong(\"".$row['id']."\")'>
                            </td>
                        </tr>";
            }
            echo            "</tbody>
...
<script src="../item/js/perfect-scrollbar.min.js"></script>
<script>
