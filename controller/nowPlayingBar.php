...
<script>
    ...
    function setRepeat() {
        ...
        $(".controlButton.repeat img").attr("src", "../item/images/other_img/" + image);
    }
    ...
    function setMute() {
        ...
        $(".controlButton.volume img").attr("src", "../item/images/other_img/" + image);
    }
    ...
    function setShuffle() {
        ...
        $(".controlButton.shuffle img").attr("src", "../item/images/other_img/" + image);
            ...
            <div class="content playerControls">
                <div class="buttons">
                    <button class="controlButton shuffle" title="Shuffle" onclick="setShuffle();">
                        <img src="../item/images/other_img/shuffle.png" alt="Shuffle">
                    </button>
                    <button class="controlButton previous" title="Previous" onclick="previousSong();">
                        <img src="../item/images/other_img/previous.png" alt="Previous">
                    </button>
                    <button class="controlButton play" title="Play" onclick="playSong();">
                        <img src="../item/images/other_img/play.png" alt="Play">
                    </button>
                    <button class="controlButton pause" title="Pause" onclick="pauseSong();">
                        <img src="../item/images/other_img/pause.png" alt="Pause">
                    </button>
                    <button class="controlButton next" title="Next" onclick="nextSong();">
                        <img src="../item/images/other_img/next.png" alt="Next">
                    </button>
                    <button class="controlButton repeat" title="Repeat" onclick="setRepeat();">
                        <img src="../item/images/other_img/repeat.png" alt="Repeat">
                    </button>
                </div>
        ...
        <div id="nowPlayingRight">
            <div class="volumeBar">
                <button class="controlButton volume" title="Volume" onclick="setMute();">
                    <img src="../item/images/other_img/volume.png" alt="Volume">
                </button>
                <div class="progressBar">
                    <div class="progressBarBG">
                        <div class="progress"></div>
